                ...
                <Box className='formContainer'>
                    ...
                    <FormGroup>
                        ...
                        <FormControl required sx={{ m: 1, minWidth: 120, zIndex: 0, marginTop: "30px" }}>
                            ...
                            <input accept="image/*" type="file" accept="image/*" onChange={handleChange2} />
                            {/* <Box sx={style.uploadBtn}>
                                <input accept="image/*" id="icon-button-file" type="file" accept="image/*" onChange={handleChange2} style={{ display: "none" }} />
                                <label for="icon-button-file">Upload</label>
                            </Box> */}
                        </FormControl>
                        <FormControl required sx={{ m: 1, minWidth: 120, zIndex: 0, marginTop: "30px" }}>
                            <Typography variant="h6">PSA Birth Certificate</Typography>
                            <input accept="image/*" type="file" accept="image/*" onChange={handleChange3} />
                            {/* <Box sx={style.uploadBtn}>
                                <input accept="image/*" id="icon-button-file" type="file" accept="image/*" onChange={handleChange3} style={{ display: "none" }} />
                                <label for="icon-button-file">Upload</label>
                            </Box> */}
                        </FormControl>
